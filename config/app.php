...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'HasFactory' => Illuminate\Database\Eloquent\Factories\HasFactory::class,
        'User' => App\Models\User::class,
        //'Dateintl' => Approached\LaravelDateInternational\DateIntlFacade::class,
     
        'Module' => Nwidart\Modules\Facades\Module::class,
  
        'Purify' => Stevebauman\Purify\Casts\PurifyHtmlOnGet::class,
    ...
    //    'Menu' => Nwidart\Menus\Facades\Menu::class,
        ...
        'Date' => Jenssegers\Date\Date::class,
        'Actions' => Lorisleiva\Actions\Facades\Actions::class
